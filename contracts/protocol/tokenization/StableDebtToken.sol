...
contract StableDebtToken is IStableDebtToken, DebtTokenBase {
    ...
    constructor(
        ...
        public
        DebtTokenBase(pool, underlyingAsset, name, symbol, incentivesController)
    {}
    ...
    function mint(
        ...
        vars.newStableRate = (_usersStableRate[onBehalfOf].rayMul(
    ...
    function burn(
        ...
        if (previousSupply <= amount) {
            ...
            if (secondTerm >= firstTerm) {
                ...
                newAvgStableRate = _avgStableRate = (firstTerm - secondTerm)
